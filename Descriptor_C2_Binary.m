function Descriptor_C2_Binary(name, VF, recon_length, cutL)
...
image = double( image(1:cutL, 1:cutL, 1)  );
...
size(image)
[ vvff, N, nd, areas, ellist ] = Characterization_2D_descriptor(image)

num = N; 
rc_mean = sqrt( L^2 * vf / num / pi )

Els = 1./ellist; 
num_3D = num * (recon_length^2 / cutL^2) * recon_length / (rc_mean*2)
